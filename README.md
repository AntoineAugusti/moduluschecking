...
## Validity
This package follows the Vocalink specification, version 5.30, that will be live on 26/11/2018. More information about the specification can be seen on the [Vocalink website](https://www.vocalink.com/customer-support/modulus-checking).
